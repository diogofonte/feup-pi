...
-- Estado
GO
ALTER TABLE [dw].[FACTO_PROJETO]  WITH CHECK ADD  CONSTRAINT [FK_FACTO_PROJETO_DIM_ESTADO] FOREIGN KEY([FK_ESTADO_PROJETO])
REFERENCES [dw].[DIM_ESTADO] ([ID])
GO
ALTER TABLE [dw].[FACTO_PROJETO] CHECK CONSTRAINT [FK_FACTO_PROJETO_DIM_ESTADO]
-- Projeto
GO
ALTER TABLE [dw].[FACTO_PROJETO]  WITH CHECK ADD  CONSTRAINT [FK_FACTO_PROJETO_DIM_PROJETO] FOREIGN KEY([FK_PROJETO_PROJETO])
REFERENCES [dw].[DIM_PROJETO] ([ID])
GO
ALTER TABLE [dw].[FACTO_PROJETO] CHECK CONSTRAINT [FK_FACTO_PROJETO_DIM_PROJETO]
-- Calendario
GO
ALTER TABLE [dw].[FACTO_PROJETO]  WITH CHECK ADD  CONSTRAINT [FK_FACTO_PROJETO_DIM_CALENDARIO] FOREIGN KEY([FK_CALENDARIO_PROJETO])
...
GO
ALTER TABLE [dw].[FACTO_PROJETO]  WITH CHECK ADD  CONSTRAINT [FK_FACTO_PROJETO_DIM_CLASSIFICACAO_PRODUTIVIDADE_PROJETO] FOREIGN KEY([FK_CLASSIFICACAO_PRODUTIVIDADE_PROJETO])
...
-- Projeto
GO
ALTER TABLE [dw].[FACTO_TAREFA]  WITH CHECK ADD  CONSTRAINT [FK_FACTO_TAREFA_DIM_PROJETO] FOREIGN KEY([FK_PROJETO_TAREFA])
REFERENCES [dw].[DIM_PROJETO] ([ID])
GO
ALTER TABLE [dw].[FACTO_TAREFA] CHECK CONSTRAINT [FK_FACTO_TAREFA_DIM_PROJETO]
-- Calendario
GO
ALTER TABLE [dw].[FACTO_TAREFA]  WITH CHECK ADD  CONSTRAINT [FK_FACTO_TAREFA_DIM_CALENDARIO] FOREIGN KEY([FK_CALENDARIO_TAREFA])
REFERENCES [dw].[DIM_CALENDARIO] ([ID])
GO
ALTER TABLE [dw].[FACTO_TAREFA] CHECK CONSTRAINT [FK_FACTO_TAREFA_DIM_CALENDARIO]
-- Tarefa
GO
ALTER TABLE [dw].[FACTO_TAREFA]  WITH CHECK ADD  CONSTRAINT [FK_FACTO_TAREFA_DIM_TAREFA] FOREIGN KEY([FK_TAREFA_TAREFA])
REFERENCES [dw].[DIM_TAREFA] ([ID])
GO
ALTER TABLE [dw].[FACTO_TAREFA] CHECK CONSTRAINT [FK_FACTO_TAREFA_DIM_TAREFA]
-- Funcionario
GO
ALTER TABLE [dw].[FACTO_TAREFA]  WITH CHECK ADD  CONSTRAINT [FK_FACTO_TAREFA_DIM_FUNCIONARIO] FOREIGN KEY([FK_FUNCIONARIO_TAREFA])
REFERENCES [dw].[DIM_FUNCIONARIO] ([ID])
GO
ALTER TABLE [dw].[FACTO_TAREFA] CHECK CONSTRAINT [FK_FACTO_TAREFA_DIM_FUNCIONARIO]
-- Classificação Produtividade
GO
ALTER TABLE [dw].[FACTO_TAREFA]  WITH CHECK ADD  CONSTRAINT [FK_FACTO_TAREFA_DIM_CLASSIFICACAO_PRODUTIVIDADE_TAREFA] FOREIGN KEY([FK_CLASSIFICACAO_PRODUTIVIDADE_TAREFA])
